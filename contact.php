        ...
        <div class="cs-contact_right cs-accent_10_bg">
          ...
          <form class="cs-contact_form">
            <div class="row cs-row_gap_20">
                ...
                <input type="text" class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color" placeholder="First name">
              
         
                <input type="text" class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color" placeholder="Last name">
             
                <input type="text" class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color" placeholder="Phone">
           
                <input type="text" class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color" placeholder="Email">
               
                <textarea cols="30" rows="5" class="cs-form_field cs-white_bg cs-accent_30_border cs-primary_color" placeholder="Your Message"></textarea>
         
                <button class="cs-btn cs-style6 cs-rounded text-uppercase cs-medium cs-accent_border cs-accent_bg cs-white cs-accent_10_bg_hover cs-accent_40_border_hover cs-accent_color_hover"><span class="cs-btn_text">Send Message</span></button>
              </div>
            </div>
          </form>
        </div>
